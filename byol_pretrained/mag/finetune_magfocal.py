...
def train():
    ...
    torch.save(model.state_dict(), os.path.join("pet_biometric_challenge_2022", "byol_coco_res152_magfocal_network_b32.pt"))
    torch.save(mag_linear.state_dict(), os.path.join("pet_biometric_challenge_2022", "byol_coco_magfocal_magface_b32.pt"))
