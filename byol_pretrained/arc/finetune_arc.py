...
def train():
    ...
    torch.save(model.state_dict(), os.path.join("pet_biometric_challenge_2022", "byol_coco_res152_arc_network_b32.pt"))
    torch.save(arcface_loss.state_dict(), os.path.join("pet_biometric_challenge_2022", "byol_coco_arc_arcface_b32.pt"))
