...
def train():
    ...
    optimizer = Adam([{"params": siamese_model.parameters()},
    ...
    for epoch in range(num_epochs):
        ...
        #     torch.save(siamese_model.state_dict(), os.path.join("pet_biometric_challenge_2022", "classify", f"res50_magcon{epoch + 1}_network.pt"))
        #     torch.save(mag_linear.state_dict(), os.path.join("pet_biometric_challenge_2022", "classify", f"res50_magcon{epoch + 1}_magface.pt"))
        scheduler.step()

    torch.save(siamese_model.state_dict(), os.path.join("pet_biometric_challenge_2022", "classify_res50_magfocal_network_2.pt"))
    torch.save(mag_linear.state_dict(), os.path.join("pet_biometric_challenge_2022", "classify_res50_magfocal_magface_2.pt"))
